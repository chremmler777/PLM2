...
export const cmLabels: Record<string, Record<Lang, string>> = {
  ...
  // Adding a department after the routing was built (routing deviation).
  'routingDev.add': { de: 'Abteilung hinzufügen', en: 'Add department' },
  'routingDev.addTitle': {
    de: 'Abteilung zur Bewertung hinzufügen',
    en: 'Add a department to the assessment',
  },
  ...
  'routingDev.templateHint': {
    de: 'Nach Freigabe des Änderungsantrags wird die Abteilung in den Standard-Routing für diesen Änderungstyp übernommen.',
    en: 'Once this change is released, the department becomes part of the standard routing for this change type.',
  },
  'routingDev.leadHint': {
    de: 'Die Änderung wird erst wirksam, wenn der Change Lead sie freigibt (Vier-Augen-Prinzip).',
  ...
  'routingDev.addBlocked': {
    ...
    en: 'Decide the pending routing change first.',
  },
  'routingDev.approve': { de: 'Freigeben', en: 'Approve' },
  'routingDev.reject': { de: 'Ablehnen', en: 'Reject' },
  'routingDev.rejectTitle': { de: 'Routing-Änderung ablehnen', en: 'Reject routing change' },
  'routingDev.rejectLabel': { de: 'Begründung', en: 'Reason' },
  'routingDev.rejectWarning': {
    de: 'Die hinzugefügte Abteilung wird wieder entfernt, ihre Aufgabe gelöscht.',
    en: 'The added department is removed again and its task deleted.',
  },
