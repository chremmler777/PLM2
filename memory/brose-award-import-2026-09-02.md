...
- Project **1994A Brose Backpanel** (PLM id 34, from RFQ2 rfq 25): 3 articles, tools 1994A-1 (971, 2-cav), 1994A-2 (971.B + 972.A, 1+1).
- Project **1994B Brose Seat Trim** (PLM id 35, from RFQ2 rfq 26): 15 articles, tools 1994B-1..1994B-12 in RFQ tooling_calc order (204..217).
...
**Open with Brose (meeting list given 2026-09-02):** 206.881.480 RH side shield not on the award list but added (shares tool 1994B-8 with 479 LH, flagged in description); 799 named Outer per award (RFQ said Inner); top tether 85H.886.747 per award (RFQ quoted 3G0.886.747); not awarded: Map Pocket, Pivot Axis, Rossette, purchased parts (rfq 25), Griff 5NA.881.253 (rfq 26).
