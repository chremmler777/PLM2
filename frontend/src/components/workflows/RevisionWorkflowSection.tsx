/**
 * RevisionWorkflowSection - Workflow instance management for a part revision.
 * Shows the active RASIC workflow (start / progress / approve / reject / cancel).
 */
    ...
    <div className="bg-slate-800 rounded-lg border border-slate-700 p-4">
      ...
      {isLoading ? (
        ...
        <div className="text-center py-4">
          <p className="text-slate-400 text-sm mb-3">No active workflow for this revision.</p>
          <button
