...
export const cmLabels: Record<string, Record<Lang, string>> = {
  ...
  'costtag.other_money': { de: 'Sonstiges (Kosten)', en: 'Other (cost)' },
  ...
  'costpos.type.estimate': { de: 'Schätzung', en: 'Estimate' },
  'costpos.type.quote': { de: 'Lieferantenangebot', en: 'Vendor quote' },
