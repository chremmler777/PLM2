...
export default function ViewerToolbar({
  ...
  return (
    <div className="bg-slate-800 px-3 py-2 flex items-center gap-2 border-b border-slate-700 flex-wrap">
      {/* View Mode Toggle */}
      ...
      {/* Grid Toggle */}
      <label className="flex items-center gap-1 cursor-pointer text-xs border-r border-slate-700 pr-3">
        <input
          type="checkbox"
          checked={showGrid}
