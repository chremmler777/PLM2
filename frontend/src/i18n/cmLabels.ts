...
export const cmLabels: Record<string, Record<Lang, string>> = {
  ...
  // The ECR process map (docs/ECR_PROCESS_MAP.md) — reviewed in German, so the
  // stage titles and the responsible for each one are named in German first.
  'procmap.title': { de: 'Prozesslandkarte ECR', en: 'ECR process map' },
  'procmap.link': { de: 'Prozesslandkarte', en: 'Process map' },
  'procmap.backToChanges': { de: 'Zu den Änderungen', en: 'Back to changes' },
  'procmap.artifacts': { de: 'Artefakte / Gates', en: 'Artifacts / gates' },
  'procmap.rules': { de: 'Übergreifende Regeln', en: 'Cross-cutting rules' },
  'procmap.buildOrder': { de: 'Baureihenfolge', en: 'Build order' },
  'procmap.stage.captured': { de: 'Erfassung', en: 'Captured' },
  'procmap.stage.scoping': { de: 'Umfangsklärung (Scoping)', en: 'Scoping' },
  'procmap.stage.in_assessment': { de: 'Bewertung', en: 'Assessment' },
  'procmap.stage.costing': { de: 'Kostenerfassung', en: 'Costing' },
  'procmap.stage.quoting': { de: 'Angebotserstellung', en: 'Quote creation' },
  'procmap.stage.quoted': { de: 'Angebot & Verhandlung', en: 'Quoted & negotiation' },
  'procmap.stage.scheduling': { de: 'Terminplanung / Bank-Build', en: 'Scheduling / bank build' },
  'procmap.stage.in_implementation': { de: 'Umsetzung', en: 'Implementation' },
  'procmap.stage.in_validation': { de: 'Validierung', en: 'Validation' },
  'procmap.stage.released': { de: 'Freigegeben — umgesetzt', en: 'Released — implemented' },
  'procmap.role.captured': { de: 'Vertrieb', en: 'Sales' },
  'procmap.role.scoping': { de: 'PM (+ Projektteam)', en: 'PM (+ project team)' },
  'procmap.role.in_assessment': {
    de: 'Geroutete Fachbereiche (Vertrieb ausgenommen)',
    en: 'Routed departments (Sales exempt)',
  },
  'procmap.role.costing': {
    de: 'Fachbereiche; PM sieht alles',
    en: 'Departments; PM sees all',
  },
  'procmap.role.quoting': { de: 'Nur Vertrieb', en: 'Sales only' },
  'procmap.role.quoted': { de: 'Vertrieb', en: 'Sales' },
  'procmap.role.scheduling': {
    de: 'Terminplanung (+ Vertrieb veröffentlicht)',
    en: 'Scheduling (+ Sales publishes)',
  },
  'procmap.role.in_implementation': {
    de: 'Umsetzende Fachbereiche + Lieferanten',
    en: 'Implementing departments + vendors',
  },
  'procmap.role.in_validation': {
    de: 'Jeder Fachbereich (eigene Prüfungen)',
    en: 'Each department (its own checks)',
  },
  'procmap.role.released': { de: 'PM', en: 'PM' },
