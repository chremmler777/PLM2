...
export const cmLabels: Record<string, Record<Lang, string>> = {
  ...
  'costtag.other_money': { de: 'Sonstiges (extern)', en: 'Other (external)' },
  'costtag.other_time': { de: 'Sonstiges (Eigenzeit)', en: 'Other (own time)' },
  'costtag.tool_rework': { de: 'Werkzeugnacharbeit', en: 'Tool rework' },
  'costtag.hot_runner': { de: 'Heißkanal', en: 'Hot runner' },
  'costtag.steel_insert': { de: 'Stahleinsatz', en: 'Steel insert' },
  'costtag.tool_transfer': { de: 'Werkzeugtransfer', en: 'Tool transfer' },
  'costtag.spare_part': { de: 'Ersatzteil', en: 'Spare part' },
  'costtag.trial_support': { de: 'Versuchsbegleitung', en: 'Trial support' },
  'costtag.trial_equipment': { de: 'Versuchsausrüstung', en: 'Process trial equipment' },
  'costtag.cycle_time_study': { de: 'Zykluszeitstudie', en: 'Cycle time study' },
  'costtag.parameter_setup': { de: 'Parametereinstellung', en: 'Parameter setup' },
  'costtag.fixture_change': { de: 'Vorrichtungsänderung', en: 'Fixture change' },
  'costtag.eoat_change': { de: 'EOAT-Änderung', en: 'EOAT change' },
  'costtag.line_layout': { de: 'Linienlayout', en: 'Line layout' },
  'costtag.robot_program': { de: 'Roboterprogramm', en: 'Robot program' },
  'costtag.work_instruction': { de: 'Arbeitsanweisung', en: 'Work instruction' },
  'costtag.setup': { de: 'Einrichtung', en: 'Setup' },
  'costtag.measurement_equipment': { de: 'Messmittel', en: 'Measurement equipment' },
  'costtag.supplier_audit': { de: 'Lieferantenaudit', en: 'Supplier audit' },
  'costtag.layout_inspection': { de: 'Erstmusterprüfung', en: 'Layout inspection' },
  'costtag.capability_study': { de: 'Fähigkeitsuntersuchung', en: 'Capability study' },
  'costtag.ppap_documentation': { de: 'PPAP-Dokumentation', en: 'PPAP documentation' },
  'costtag.control_plan_update': { de: 'Control Plan', en: 'Control plan update' },
  'costtag.pfmea_update': { de: 'PFMEA', en: 'PFMEA update' },
  'costtag.run_at_rate': { de: 'Run at Rate', en: 'Run at rate' },
  'costtag.simulation': { de: 'Simulation', en: 'Simulation' },
  'costtag.cad_update': { de: 'CAD-Anpassung', en: 'CAD update' },
  'costtag.drawing_update': { de: 'Zeichnungsanpassung', en: 'Drawing update' },
  'costtag.tolerance_study': { de: 'Toleranzstudie', en: 'Tolerance study' },
  'costtag.dunnage': { de: 'Ladungsträger', en: 'Dunnage' },
  'costtag.packaging_trial': { de: 'Verpackungsversuch', en: 'Packaging trial' },
  'costtag.freight': { de: 'Fracht', en: 'Freight' },
  'costtag.packaging_trial_support': { de: 'Versuchsbegleitung Verpackung', en: 'Packaging trial support' },
  'costtag.storage': { de: 'Lagerung', en: 'Storage' },
  'costtag.bank_build_planning': { de: 'Vorproduktionsplanung', en: 'Bank build planning' },
  'costtag.project_coordination': { de: 'Projektkoordination', en: 'Project coordination' },
  // The costing table.
  'costpos.col.n': { de: '#', en: '#' },
  'costpos.col.category': { de: 'Kategorie', en: 'Category' },
  'costpos.col.description': { de: 'Beschreibung', en: 'Description' },
  'costpos.col.type': { de: 'Art', en: 'Type' },
  'costpos.col.amount': { de: 'Betrag', en: 'Amount' },
  'costpos.col.leadTime': { de: 'Vorlaufzeit', en: 'Lead time' },
  'costpos.type.time': { de: 'Eigenzeit', en: 'Own time' },
  'costpos.type.estimate': { de: 'Extern · Schätzung', en: 'External · estimate' },
  'costpos.type.quote': { de: 'Extern · Angebot', en: 'External · vendor quote' },
  'costpos.pricingShort.estimate': { de: 'Schätzung', en: 'Estimate' },
  'costpos.pricingShort.quote': { de: 'Angebot', en: 'Vendor quote' },
  ...
  'costpos.partWeightRow': { de: 'Teilegewicht', en: 'Part weight' },
  'costpos.partWeightDesc': { de: 'Schätzung, wird validiert', en: 'estimate, validated later' },
  'costpos.internalEffortDesc': { de: 'Zeit für die Bewertung', en: 'time spent on the assessment' },
  'costpos.supportEffortDesc': { de: 'geschätzt', en: 'estimated' },
  'costpos.addLine': { de: 'Zeile hinzufügen', en: 'Add line' },
  'costpos.addCategory': { de: '+ Eigene Kategorie …', en: '+ Add own category…' },
  'costpos.newCategoryLabel': { de: 'Name der Kategorie', en: 'Category name' },
  'costpos.categoryType': { de: 'Zeilenart', en: 'Line type' },
  'costpos.saveCategory': { de: 'Anlegen', en: 'Add' },
  'costpos.deleteCategory': { de: 'Kategorie entfernen', en: 'Remove category' },
  'costpos.categoryAdded': { de: 'Kategorie angelegt', en: 'Category added' },
  'costpos.categoryDeleted': { de: 'Kategorie entfernt', en: 'Category removed' },
  'costpos.categoryHint': {
    de: 'Kategorien gehören der Abteilung: Mitglieder, PM und Admin pflegen die Liste.',
    en: 'Categories belong to the department: its members, PM and admin keep the list.',
  },
  'costpos.pickCategory': { de: 'Kategorie …', en: 'Category…' },
  'costpos.descPlaceholder': { de: 'Was genau?', en: 'What exactly?' },
  'costpos.total': { de: 'Summe', en: 'Total' },
  'costpos.offersCount': { de: '{n} Angebote', en: '{n} offers' },
