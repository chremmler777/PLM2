          ...
          {articles && articles.length > 0 ? (
            <table className="w-full">
              <thead className="bg-slate-700 border-b border-slate-600">
                <tr>
                  <th className="px-6 py-3 text-left text-xs font-semibold text-slate-200 uppercase">
                    Number
                  </th>
                  <th className="px-6 py-3 text-left text-xs font-semibold text-slate-200 uppercase">
                    Name
              ...
              <tbody className="divide-y divide-slate-700">
                {articles.map((article) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-slate-100">{article.name}</td>
      ...
      {showCreateModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-slate-800 rounded-lg shadow-lg max-w-md w-full mx-4">
            <div className="p-6">
              <h2 className="text-lg font-semibold text-slate-100 mb-4">Create Article</h2>
              <form onSubmit={handleCreate} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-slate-600 rounded-md focus:ring-2 focus:ring-blue-500"
